...
namespace StormWeb.Helper
{
    public static class CookieHelper
    {
        ...
        {
            string[] rolesArray = Roles.Split('|');
            return (rolesArray.Contains("Super") || rolesArray.Contains("Administrator") || rolesArray.Contains("Admission") || rolesArray.Contains("Counsellor") || rolesArray.Contains("Visa"));
        }
